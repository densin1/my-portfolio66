...
const DK_CONTENT = {
  ...
  videoProjects: [
    ...
    { id: 'proj-3', category: 'youtube', title: 'YouTube Документація: Подорож',       desc: 'Повний цикл: монтаж 15 хв, колір-корекція, графіка, саунд-дизайн. Утримання аудиторії 65%.',    thumb: 'img/project-3.jpg', video: 'video/project-3-preview.mp4', tags: ['Premiere Pro', 'Color Grading', 'Motion Graphics'], link: 'https://t.me/des1n' },
    ...
    { id: 'proj-7', category: 'reels',   title: 'Reels-розпаковка продукту',           desc: 'Динамічна презентація товару: макро-кадри, ритмічний монтаж під музику.',                        thumb: 'img/project-7.jpg', video: 'video/project-7-preview.mp4', tags: ['DaVinci Resolve', 'Product'],                        link: 'https://t.me/des1n' }
  ],
  ...
  pricing: [
    { id: 'price-reels', name: 'Reels / Shorts / TikTok', features: ['Монтаж під трендовий аудіо, динамічні переходи', 'Кольор-корекція, субтитри (авто/ручні), ефекти', 'Адаптація під 3 платформи (9:16), обкладинка'], popular: true },
    { id: 'price-youtube', name: 'YouTube / Long-form Video', features: ['Повний цикл: монтаж, саунд-дизайн, колір, графіка', 'Ретеншн-редагування (з тримаюча увага)', 'Створення енд-скрін, таймкодів, обкладинки (CTR)'], popular: false },
    { id: 'price-design', name: 'Дизайн-пакет (Бренд / Ads)', features: ['Логотип, колірна палітра, типографіка, гайдлайни', 'Креативи для реклами (статика/мобільний відео)', 'YouTube банер, аватарки, обкладинки для відео'], popular: false }
  ]
};